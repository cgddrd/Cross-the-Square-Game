...
public Highscore(Game g) {
	...
	public void setScore() throws Exception {
		...
		xmlClass.setScoreData(playerInput + "," + gameControl.getScore() + "," + dateFormatter.format(today));
		
		// Set XML sorting variable 'playerScore' to current player's score to allow bubble sort to take place (if neccessary)
		xmlClass.setPlayerScore(gameControl.getScore());
	...
	public void readScore() throws Exception {
		...
		// Once input has been given, re-display the main menu
		gameControl.runMenu();
	}
